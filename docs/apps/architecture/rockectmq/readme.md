...
3. 在服务器中查看 RocketMQ 的 **[默认账号和密码](./user/credentials)**  
4. 若想用域名访问  RocketMQ ，务必先完成 **[域名五步设置](./administrator/domain_step)** 过程
...
RocketMQ 应用中包含 Nginx, Docker 等组件，可通过 **[通用参数表](./administrator/parameter)** 查看路径、服务、端口等参数。
