...
3. 在服务器中查看 WampServer 的 **[默认账号和密码](./setup/credentials#getpw)**  
4. 若想用域名访问  WampServer，务必先完成 **[域名五步设置](./dns#domain)** 过程
...
**[通用参数表](../setup/parameter)** 中可查看 Nginx, Java, Docker, MySQL 等 WampServer 应用中包含的基础架构组件路径、版本、端口等参数。 
