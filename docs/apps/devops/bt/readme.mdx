...
BT 应用中包含 Docker, Nginx 等组件，可通过 **[通用参数表](./administrator/parameter)** 查看路径、服务、端口等参数。 

通过运行 `docker ps`，查看 {{trademark}} 运行时所有的服务组件：   

```bash
CONTAINER ID   IMAGE                  COMMAND                  CREATED         STATUS                   PORTS                                                                                                                                                                                                                                          NAMES
c528a9b3aa49   btpanel/baota:latest   "bash -c 'cat /my_cm…"   9 minutes ago   Up 8 minutes (healthy)   0.0.0.0:21->21/tcp, :::21->21/tcp, 0.0.0.0:80->80/tcp, :::80->80/tcp, 0.0.0.0:443->443/tcp, :::443->443/tcp, 0.0.0.0:8888->8888/tcp, :::8888->8888/tcp, 3306/tcp, 0.0.0.0:28->22/tcp, :::28->22/tcp, 0.0.0.0:9099->888/tcp, :::9099->888/tcp   bt
```
...
* 安装目录：*/data/apps/bt/data/www/server*  
* 网站目录：*/data/apps/bt/data/www/wwwroot/default*  
* Apache目录：*/data/apps/bt/data/www/server/httpd*  
* Nginx目录：*/data/apps/bt/data/www/server/nginx*  
* MySQL目录：*/data/apps/bt/data/www/server/mysql*  
* PHP目录：*/data/apps/bt/data/www/server/php*  
* Redis目录：*/data/apps/bt/data/www/server/redis*  
* 日志目录：*/data/apps/bt/data/www/wwwlogs*
...
```shell
sudo docker start | stop | restart | stats bt
```
