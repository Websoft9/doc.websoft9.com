...
CmsEasy 预装包包含 CmsEasy 运行所需一序列支撑软件（简称为“组件”），下面列出主要组件名称、安装路径、配置文件地址、端口、版本等重要的信息。
...
使用由 Websoft9 提供的 CmsEasy 部署方案，可能需要用到的服务如下：
...
2. 通过 phpMyAdmin 导出 CmsEasy 数据库
