...
**[域名五步设置](./administrator/domain_step)** 完成后，需设置 Budibase 的 URL:  
...
| 端口号 | 用途                                          | 必要性 |
| ------ | --------------------------------------------- | ------ |
| 8080   | Budibase 原始端口，已通过 Nginx 转发到 80 端口 | 可选   |
