[MongoDB Compass](https://www.mongodb.com/products/compass) 是一个 **MongoDB 官方可视化工具**，它被用于 数据库工具  等场景。Compass 是一款免费的交互式工具，用于查询、优化和分析 MongoDB 数据。您可以通过拖放来构建管道等方式获得关键见解。
