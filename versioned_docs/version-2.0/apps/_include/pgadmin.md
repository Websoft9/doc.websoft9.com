[pgAdmin](https://www.pgadmin.org/) 是一个 **Web 图形化 PostgreSQL 数据库管理工具**，它被用于 数据库工具  等场景。pgAdmin 官方出品具有 Web 界面的 PostgreSQL 数据库管理和开发平台。
...
- [登录 Websoft9 控制台](./login-console)，然后找到（或安装）pgAdmin：
  - **我的应用** 菜单找到应用 
  - **应用商店** 菜单部署应用
