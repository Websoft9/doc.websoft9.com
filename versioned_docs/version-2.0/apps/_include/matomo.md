[Matomo Analytics](https://matomo.org/) 是一个 **网站与移动应用分析平台**，它被用于 网站访问分析 内容营销技术  等场景。Matomo是Google Analytics（分析）的领先开放替代方案，可让您完全控制数据。Matomo让您可以轻松地从网站和应用程序中收集数据，并将其可视化。
