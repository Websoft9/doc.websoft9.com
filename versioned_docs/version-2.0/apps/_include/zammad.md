[Zammad](https://zammad.org/) 是一个 **客服与工单系统**，它被用于 客服/售后/支持  等场景。Zammad 是一个基于 Web 的开源帮助台/客户支持系统，具有许多 通过电话等多种渠道管理客户沟通的功能， 脸书、推特、聊天和电子邮件。
...
- [登录 Websoft9 控制台](./login-console)，然后找到（或安装）Zammad：
  - **我的应用** 菜单找到应用 
  - **应用商店** 菜单部署应用
