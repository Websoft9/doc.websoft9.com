[NocoDB](https://www.nocodb.com/) is **The Open Source Airtable Alternative**, used for Low Code and No Code . NocoDB is an open source #NoCode platform that turns any database into a smart spreadsheet.
