[ClamAV](https://www.clamav.net/) is **open-source antivirus engine**, used for Detection and Monitor . ClamAV is an open-source antivirus engine for detecting trojans, viruses, malware & other malicious threats.
