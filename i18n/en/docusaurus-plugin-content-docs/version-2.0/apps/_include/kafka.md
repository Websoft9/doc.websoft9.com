[Apache Kafka](https://kafka.apache.org/) is **Open-source distributed event streaming platform**, used for Message Queue . Apache Kafka® is used for building real-time data pipelines and streaming apps.
