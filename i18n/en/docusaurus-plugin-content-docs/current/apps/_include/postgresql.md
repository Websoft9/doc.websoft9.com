[PostgreSQL](https://www.postgresql.org/) is **A open source object-relational database system**, used for Relational Databases . PostgreSQL is a powerful,open source object-relational database system(ORDBMS). 
