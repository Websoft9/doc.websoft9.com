[RethinkDB](https://rethinkdb.com/) is **A NoSQL database that stores schemaless JSON documents**, used for NoSQL Database . RethinkDB is a NoSQL database that stores schemaless JSON documents. 
